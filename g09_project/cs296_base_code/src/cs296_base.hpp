...
namespace cs296
{
	...
	/*!This class implements the functionality of the scissors.*/
	class Sci
	{
		private:
		/*!Stores the world in which the scissors have to be created.*/
		b2World* world;
	
	
		public:
		/*!Constructor takes the joints to be destroyed upon contact as parameters.*/
		Sci(b2World* m_world, b2Joint* mj, b2Joint* j1, b2Joint* j2);
		/*!This function is called whenever the scissors comes in contact with a dynamic body.*/
		void startContact();
	};
	
	
	/*!This class implements the Contact Listener attached to the scissors*/
	class MyContactListener : public b2ContactListener
	  {
	  
	    /*!This function is called whenever the listener listens to a contact(start of the contact).*/
	    ...
	    /*!This function is called whenever the listener listens to a contact(end of the contact).*/
	  ...
	  /*!This class implements all the calculations corresponding to physical laws.*/
	  struct settings_t
	  {
	      settings_t() :
	  ...
	  /*!This class implements the contact listener(for general use).*/
