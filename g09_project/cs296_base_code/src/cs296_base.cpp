...
Sci::Sci(b2World* m_world, b2Joint* mj, b2Joint* j1, b2Joint* j2){
	...
	
		{
		      ...
		      b2PolygonShape poly;
		      b2Vec2 vertices[3];
		      vertices[0].Set(-2.0,-0.25);
		      vertices[1].Set(2.0,0.25);
		      vertices[2].Set(1.0,0.25);
		      poly.Set(vertices, 3);
		      ...
		      b2BodyDef wedgebd;
		      wedgebd.position.Set(-9.0f, 29.0f);
		      sbody = m_world->CreateBody(&wedgebd);
		      sbody->CreateFixture(&wedgefd);
		      sbody->SetUserData(this);
		}
		
		{
		      ...
		      b2PolygonShape poly;
		      b2Vec2 vertices[3];
		      vertices[0].Set(-2.0,0.15);
		      vertices[1].Set(2.0,-0.15);
		      vertices[2].Set(1.0,0.15);
		      poly.Set(vertices, 3);
		      b2FixtureDef wedgefd;
		      wedgefd.shape = &poly;
		      wedgefd.density = 10.0f;
...
void base_sim_t::dest(){
 if (var == 1){
 	var=2;
	m_world->DestroyJoint(jd);
	m_world->DestroyJoint(je);
	m_world->DestroyJoint(jf);
